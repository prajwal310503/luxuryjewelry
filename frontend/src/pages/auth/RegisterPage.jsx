  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="font-heading text-[1.35rem] font-bold text-gray-900 leading-tight">Create Retailer Account</h2>
          <p className="text-xs text-gray-400">Join VK Jewellers as a retailer.</p>
        </div>
      </div>
